<%-- 
    Document   : search
    Created on : Jul 26, 2022, 10:14:06 AM
    Author     : ADMIN
--%>
...
<div class="page-title-search">
    <div class="flex-title-left">
        <span>Trang chủ / cửa hàng / </span><B>kết quả tìm kiếm 'A'</B>
    </div>
            ...
            <div class="flex-list-display">
                <div class="flexwrap-item-row">
                    <div class="entity-display">
                        <img src="http://mauweb.monamedia.net/petcare/wp-content/uploads/2019/10/Dog-raincoat-1-100x100.jpg" alt="">
                        <div class="text-detail">
                            <a href="#">Áo mưa cho chó</a>
                            <span>240.000đ</span>
                            <a href="#">Mua hàng</a>
                        </div>
