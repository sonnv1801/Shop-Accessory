    ...
    <div class="header-parent">
        <div class="header-child1 header-padding">
            ...
            <ul class="header-ul ul-child1">
                ...
                <li class="header-li">
                    <a href="#" style="text-decoration: none;color: rgb(108, 100, 101);">
        ...
        <div id="navbar">
            <div class="header-child2 header-padding">
                <ul class="header-ul ul-child2">
                    <li class="header-li">
                        <a href="trangchu.html"><img class="img-logo" id="subnavbar" src="http://mauweb.monamedia.net/petcare/wp-content/uploads/2019/11/Pet-Care-1.png" alt=""></a>
                    </li>
                </ul>
                <ul class="header-ul ul-child2">
                    <li class="header-li">
