...
<!--        <link rel="stylesheet" href="./css/bootstrap-5/css/bootstrap.min.css">-->
        ...
        <link rel="stylesheet" href="../css/Style_tin/css/productDetails.css">
                        ...
                        <div class="body">
                                ...
                                <div class="col-6">
                                    <div class="body_img">
                                        <div class="body_img_details">
                                            <img class="image-show" src="http://mauweb.monamedia.net/petcare/wp-content/uploads/2019/10/Dogs-Winter-Jacket-1-100x100.jpg" alt="">
                                            <!-- Mũi tên hover -->
                                                ...
                                                <form action="#" method="">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="box-select--wrap box-select--wrap--color">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="box-select--wrap box-select--wrap--size">
                                                                    <div class="box-select">
                                                                        <span>Chọn một tùy chọn</span> 
                                                                    </div>
                                                                    <i class="ti-angle-down"></i>
                                            ...
                                            <div class="payments">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <img src="./img/ship/logo-ghn.jpg" alt="">
                                                        <img src="./img/ship/logo-ghtk.jpg" alt="">
                                                        <img src="./img/ship/logo-ninja-van.jpg" alt="">
                                                        <img src="./img/ship/logo-shipchung.jpg" alt="">
                                                        <img src="./img/ship/logo-viettle-post.jpg" alt="">
                                                        <img src="./img/ship/logo-vn-post.jpg" alt="">
                                                    </div>
                                                    <div class="col-6">
                                                        <h6>Thanh toán</h6>
                                                        <img src="./img/bank/logo-acb.jpg" alt="">
                                                        <img src="./img/bank/logo-mastercard.jpg" alt="">
                                                        <img src="./img/bank/logo-paypal.jpg" alt="">
                                                        <img src="./img/bank/logo-techcombank.jpg" alt="">
                                                        <img src="./img/bank/logo-vcb.jpg" alt="">
                                                        <img src="./img/bank/logo-vib.jpg" alt="">
                                                    </div>
                            ...
                            <div class="content_mota">
                                <p class="text__footer">
                                    Trong trường hợp bạn tìm cách tạo một cửa hàng trực tuyến, Thú cưng tích hợp WooC Commerce là giải pháp. Hãy tự bảo vệ mình với giải pháp WordPress mạnh mẽ này.
                                    <br/>
                                    Tất cả các chủ đề của chúng tôi đều đi kèm với Tài liệu HTML mở rộng hướng dẫn bạn cách cài đặt và đặt chủ đề đúng cách. Cũng như Nhóm Hỗ trợ thân thiện của chúng tôi sẽ trở thành người trợ giúp đáng tin cậy với tất cả các vấn đề bạn có thể gặp phải.
                                </p>
                                <ul class="text__footer--list">
                                    <li>
                                        thẻ tín dụng / thẻ ghi nợ hoặc qua PayPal
                                    </li>
                                    <li>
                                        miễn thuế
                                    </li>
